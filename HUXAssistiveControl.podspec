#
#  Be sure to run `pod spec lint HUXAssistiveControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of HUXAssistiveControl."
  ...
  # s.authors      = { "HAOZHE XU" => "hao@guistudio.net", "other author" => "email@address.com" }
  # s.author       = 'HAOZHE XU', 'other author'
  ...
  s.source       = { :git => "http://EXAMPLE/HUXAssistiveControl.git", :tag => "0.0.1" }
